...
namespace BiSchool.BL
{
    public class Fees
    {
        ...
        public static int Create(string usrName, int StudentId, decimal Amount, DateTime Date)
        {
            ...
            try
            {
                int res = FeesData.Create(StudentId, Amount, Date, CreatedDate, CreatedBy,  ModifiedDate, ModifiedBy,  IsDeleted);
        ...
        public bool Update(string usrName)
        {
            try
            {
                bool returnVal = FeesData.Update(Id, StudentId, Amount, Date, CreatedDate, CreatedBy, ModifiedDate, ModifiedBy,  IsDeleted);
