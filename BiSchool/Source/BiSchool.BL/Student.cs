    ...
    public class Student
    {
        ...
        public static bool Delete(string usrName, int id)
        {
            try
            {
                ...
                bool res = StudentData.Delete(id, modifiedBy, modifiedDate);

                Activity.Create(usrName, "Student", "Delete",
        ...
        public bool Delete(string usrName)
        {
            try
            {
                ...
                bool returnVal = StudentData.Delete(this.Id, modifiedBy, modifiedDate);
